...
La version de Python embarquée dans l'installation de QGIS se découvre en parcourant le menu "Help>About" de QGIS.\\
...
\begin{minted}[frame=single,
  ...
  fontsize=\small,
  framesep=1mm]{python3}
<qgis._core.QgsFeatureIterator obejct at 0x0000000001BF57E18>
\end{minted}
\end{minipage}
\end{center}
\vspace*{1em}
